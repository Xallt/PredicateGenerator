...
if __name__ == '__main__':
    ...
    sents = Evolution.trans_generate(translator, 40, True, True, True, True, True, verbose=True)
    print('This process took {} seconds'.format(time.clock() - start))
    print('Length: {}'.format(len(sents)))
    print(TeX_Transformer.transform_list(sents), file=open('TeX/TeX_doc.tex', 'w'))
#Специализация